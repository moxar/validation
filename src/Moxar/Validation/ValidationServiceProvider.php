...
class ValidationServiceProvider extends ServiceProvider {
	...
	protected function ratio() {
            $this->app->before(function() {
                Validator::extend('ratio', 'Moxar\Valiadation\Rules\Image@ratio');
        ...
        protected function minWidth() {
            $this->app->before(function() {
                Validator::extend('minWidth', 'Moxar\Valiadation\Rules\Image@minWidth');
        ...
        protected function maxWidth() {
            $this->app->before(function() {
                Validator::extend('maxWidth', 'Moxar\Valiadation\Rules\Image@maxWidth');
        ...
        protected function width() {
            $this->app->before(function() {
                Validator::extend('width', 'Moxar\Valiadation\Rules\Image@width');
        ...
        protected function minHeight() {
            $this->app->before(function() {
                Validator::extend('minHeight', 'Moxar\Valiadation\Rules\Image@minHeight');
        ...
        protected function maxHeight() {
            $this->app->before(function() {
                Validator::extend('maxHeight', 'Moxar\Valiadation\Rules\Image@maxHeight');
        ...
        protected function height() {
            $this->app->before(function() {
                Validator::extend('height', 'Moxar\Valiadation\Rules\Image@height');
        ...
        protected function uniqueLang() {
            $this->app->before(function() {
                Validator::extend('uniqueLang', 'Moxar\Valiadation\Rules\Translate@uniqueLang');
            });
        }
}